...
FROM ls250824/pytorch-cuda-ubuntu-develop:22092026
...
LABEL org.opencontainers.image.title="Pytorch CUDA Devel + PyTorch Image" \
      org.opencontainers.image.description="Pytorch 2.12.1 CUDA 13.0.x devel + code-server + Jupyter + Gradio + civitai CLI" \
